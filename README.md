...
- [Plugin-TreeSitter](https://github.com/krzyzanowskim/STTextView-Plugin-TreeSitter) Source code syntax highlighting with [Tree-sitter](https://tree-sitter.github.io/tree-sitter/).

...
final class SizeToFitTests: XCTestCase {
    ...
    func testCompareUsageBoundsForTextContainer() {
        ...
        XCTAssertEqual(nsTextView.textLayoutManager!.usageBoundsForTextContainer, stTextView.textLayoutManager.usageBoundsForTextContainer)
    }
    ...
    func testWrapModeLongLineWraps() {
        ...
        stTextView.isVerticallyResizable = true
        stTextView.isHorizontallyResizable = false
        stTextView.setString("This is a very long line of text that definitely should wrap to multiple lines when the container is narrow")
        stTextView.sizeToFit()

...
extension STTextView {
    ...
    public func textAttachments(in range: NSTextRange? = nil) -> [(attachment: NSTextAttachment, range: NSTextRange)] {
    ...
    public func textAttachment(at location: NSTextLocation) -> NSTextAttachment? {
    ...
    public func textAttachmentRange(at location: NSTextLocation) -> NSTextRange? {
    ...
    public func replaceAttachment(in range: NSTextRange, with attachment: NSTextAttachment) {
    ...
    public func removeAttachment(in range: NSTextRange) {
    ...
    public func insertAttachment(_ attachment: NSTextAttachment, at location: NSTextLocation) {
        let attributedString = NSAttributedString(attachment: attachment)
    ...
    public func attachmentView(at location: NSTextLocation) -> NSView? {
    ...
    /// - Returns: true if the attachment was successfully selected, false otherwise.
    @discardableResult
    public func selectAttachment(_ attachment: NSTextAttachment) -> Bool {
